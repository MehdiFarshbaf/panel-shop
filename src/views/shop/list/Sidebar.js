...
const defaultValues = {
    ...
    mobile: null,
    telephone: null,
    is_special: {value: 0, label: "هر دو"},
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
                <div className='mb-1'>
                    ...
                    <Controller
                        ...
                        control={control}
                        render={({field}) => (
                            <Input id='last_name' placeholder='  نام خانوادگی'
                ...
                <div className='mb-1'>
                    ...
                    <Controller
                        ...
                        control={control}
                        render={({field}) => (
                            <Input id='store_name' placeholder='نام فروشگاه'
                                   invalid={errors.store_name && true} {...field} />
                        )}
                    />
                </div>
                <div className='mb-1'>
                    ...
                    <Controller
                        ...
                        render={({field}) => (
                            <Select
                                ...
                                options={cities.map(p => ({label: p.name, value: p.id}))}
                ...
                <div className='mb-1'>
                    ...
                    {appConfig.specialProduct && <Controller
                        name='is_special'
                        control={control}
                        render={({field}) => (
                            // <Input id='status' placeholder='Australia' invalid={errors.status && true}
                            ...
                            <Select
                                ...
                                options={[
                                    {value: "1", label: "ویژه"},
                                    {value: "0", label: "غیر ویژه"},
                                    {value: 0, label: "هر دو"}]
                                }
                                theme={selectThemeColors}
                                placeholder="انتخاب حالت ویژه یا غیر ویژه "
