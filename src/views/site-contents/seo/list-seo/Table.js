          ...
          <div className = "invoice-list-table-header w-100 me-1 ms-50 mt-2 mb-75" >
               <Row >
                    <Col xl = "6" className = "d-flex align-items-center p-0 px-lg-1" >
                       ...
                       <Button tag = { Link } to = "/site-content/seo/create" color = "primary" >
                          اضافه کردن
                       </Button >
                    </Col >
                    <Col
...
const TableList = () => {
     ...
     const CustomPagination = () => {
          const count = Number(Math.ceil(store.totalSeo / rowsPerPage))
     ...
     const dataToRender = () => {
          ...
          if (store.data.length > 0) {
               ...
               return store.allDataSeo.slice(0, rowsPerPage)
          }
     }
     ...
     const customStyles = {
          ...
          rows : {
               ...
               style : {
                    minHeight : rowsPerPage - ((rowsPerPage * currentPage) - store.totalSeo) === 1 ? "210px" : rowsPerPage - ((rowsPerPage * currentPage) - store.totalSeo) === 2 ? "100px" : "80px" // override
                    // the row
                    // height
               }
          }
